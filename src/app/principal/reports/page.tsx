...
export default function PrincipalReportsPage() {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          type: "error",
          text: errorData.error || "Rapor oluşturulurken hata oluştu",
        });
      }
    } catch (error) {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const reportType =
        reportConfig.type === "attendance" ? "devamsizlik" : "finansal";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            {principalSchool?.name} - Devamsızlık ve finansal raporları oluştur
            ve dışa aktar
          </p>
        </div>
      </div>
      ...
      <div className="rounded-lg bg-white p-6 shadow-card dark:bg-gray-dark">
        ...
        <div className="mt-6 flex justify-end">
          <button
            ...
            disabled={
              isGenerating || !reportConfig.startDate || !reportConfig.endDate
            }
            ...
            {reportConfig.type === "attendance" ? (
              <div>
                ...
                <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
                  {formatDate(reportConfig.startDate)} -{" "}
                  {formatDate(reportConfig.endDate)}
                </p>
                {reportData.summary && (
                  <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div className="rounded-lg border p-4">
                      ...
                      <p className="text-xl font-bold text-red-600">
                        {reportData.summary.absenteeismRate}%
                      </p>
                    </div>
                  </div>
                )}
                ...
                {reportData.summary && (
                  <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div className="rounded-lg border p-4">
                      ...
                      <p
                        className={`text-xl font-bold ${(reportData.summary.netProfit || 0) >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
