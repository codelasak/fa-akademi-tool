    ...
    try {
      ...
      const summary: FinancialSummary = {
        ...
        currentMonthWages: wages
          .filter(
            (w: any) => w.month === currentMonth && w.year === currentYear,
          )
          .reduce((sum: number, w: any) => sum + parseFloat(w.totalAmount), 0),
        currentMonthPayments: payments
          ...
          .reduce((sum: number, p: any) => sum + parseFloat(p.agreedAmount), 0),
        overduePayments: payments.filter((p: any) => p.status === "OVERDUE")
          .length,
            ...
            {recentTransactions.map((transaction) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <span
                    className={`inline-flex rounded-full px-2 py-1 text-xs font-medium ${getStatusColor(transaction.status)}`}
                  >
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="rounded-lg bg-white p-6 shadow-card dark:bg-gray-dark">
          ...
          <div className="space-y-3">
            <button
              onClick={() =>
                router.push("/admin/finances/wages?action=calculate")
              }
            ...
            <button
              onClick={() =>
                router.push("/admin/finances/wages?filter=pending")
              }
        ...
        <div className="rounded-lg bg-white p-6 shadow-card dark:bg-gray-dark">
          ...
          <div className="space-y-3">
            <button
              onClick={() =>
                router.push("/admin/finances/payments?action=create")
              }
            ...
            <button
              onClick={() =>
                router.push("/admin/finances/payments?filter=pending")
              }
