...
export default function ReportsPage() {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          type: "error",
          text: errorData.error || "Rapor oluşturulamadı",
        });
      }
    } catch (error) {
      ...
      setMessage({
        type: "error",
        text: "Rapor oluşturma sırasında hata oluştu",
      });
    } finally {
  ...
  const generatePDF = async (data: any) => {
    try {
      ...
      if (!element) {
        setMessage({
          type: "error",
          text: "PDF oluşturulamadı: İçerik bulunamadı",
        });
        return;
      }
      ...
      setMessage({
        type: "error",
        text: "PDF oluşturma sırasında hata oluştu",
      });
    }
  };
  ...
  const filteredClasses = classes.filter(
    (cls) => !reportConfig.schoolId || cls.schoolId === reportConfig.schoolId,
  );
  ...
  return (
    <div className="space-y-6">
      ...
      {reportData && reportConfig.format === "json" && (
        <div
          id="report-content"
          className="rounded-lg bg-white p-6 shadow-card dark:bg-gray-dark"
        >
          <div className="mb-6 border-b border-gray-200 pb-4 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {new Date(reportData.metadata.dateRange.start).toLocaleDateString(
                "tr-TR",
              )}{" "}
              -{" "}
              {new Date(reportData.metadata.dateRange.end).toLocaleDateString(
                "tr-TR",
              )}
            </p>
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  ...
                  <div className="text-center">
                    <p className="text-2xl font-bold text-yellow-600">
                      {reportData.summary.studentsWithConcerns}
                    </p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Sorunlu Öğrenci
                    </p>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      ...
                      <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                        {reportData.analytics.concernStudents.map(
              ...
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {reportData.analytics.byClass.map(
              ...
              {reportData.summary && (
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                    ...
                    <div className="text-center">
                      <p
                        className={`text-2xl font-bold ${reportData.summary.netResult >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
                    ...
                    <div className="text-center">
                      <p className="text-2xl font-bold text-blue-600">
                        {formatPercentage(reportData.summary.netMargin)}
                      </p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Kar Marjı
                      </p>
                  ...
                  <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
                    <div className="text-center">
                      <p className="text-xl font-bold text-blue-600">
                        {formatCurrency(
                          reportData.wageData.analytics.totalWages,
                        )}
                      </p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Toplam Maaş
                    ...
                    <div className="text-center">
                      <p className="text-xl font-bold text-green-600">
                        {formatCurrency(
                          reportData.wageData.analytics.totalPaid,
                        )}
                      </p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Ödenen
                    ...
                    <div className="text-center">
                      <p className="text-xl font-bold text-yellow-600">
                        {formatCurrency(
                          reportData.wageData.analytics.totalPending,
                        )}
                      </p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Bekleyen
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
                    <div className="text-center">
                      <p className="text-xl font-bold text-blue-600">
                        {formatCurrency(
                          reportData.paymentData.analytics.totalRevenue,
                        )}
                      </p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Toplam Gelir
                    ...
                    <div className="text-center">
                      <p className="text-xl font-bold text-green-600">
                        {formatCurrency(
                          reportData.paymentData.analytics.totalReceived,
                        )}
                      </p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Alınan
                    ...
                    <div className="text-center">
                      <p className="text-xl font-bold text-yellow-600">
                        {formatCurrency(
                          reportData.paymentData.analytics.totalPending,
                        )}
                      </p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Bekleyen
