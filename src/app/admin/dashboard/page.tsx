            ...
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-900">
              ...
              >
                <path
                  ...
                  strokeWidth="2"
                  d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-1.29a2.25 2.25 0 00-2.5-2.5M15 10.5a3 3 0 11-6 0 3 3 0 016 0z"
                />
              </svg>
            </div>
          </div>
            ...
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-yellow-100 dark:bg-yellow-900">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M9 7l1-1v-1a3 3 0 116 0v1l1 1m-9 11h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z"
                />
              </svg>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Kullanıcı ekle, düzenle veya sil
              </p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Ödemeleri ve maaşları takip et
              </p>
            </div>
          </a>
        </div>
